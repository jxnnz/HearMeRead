...
export const MOCK_PASSAGES = [
  ...
  },
  {
    ...
    questions: [
      {
        id: 1,
        question: "Where was the mango tree located?",
        answer: "In a small village",
        options: ["Correct", "Wrong", "N/A"],
      },
      {
        id: 2,
        question: "What did children do under the mango tree?",
        answer: "They played every afternoon after school",
        options: ["Correct", "Wrong", "N/A"],
      },
      {
        id: 3,
        question: "What did the tree give during the dry season?",
        answer: "Sweet fruits to the hungry villagers",
        options: ["Correct", "Wrong", "N/A"],
      },
      {
        id: 4,
        question: "What did the children do to take care of the tree?",
        answer: "They watered it and cared for its roots",
        options: ["Correct", "Wrong", "N/A"],
      },
      {
        id: 5,
        question: "What lesson did the villagers learn?",
        answer: "When you take care of nature, nature takes care of you",
        options: ["Correct", "Wrong", "N/A"],
      },
    ],
  },
